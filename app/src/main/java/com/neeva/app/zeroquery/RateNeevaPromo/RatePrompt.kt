...
internal fun RatePrompt(
    ...
    ResponsiveContainer(
        ...
        Text("❤️", fontSize = 24.sp, modifier = iconModifier)
        Text(
...
@PortraitPreviews
@Composable
fun Preview_RateNeevaPromo_rate() {
...
@Composable
fun Preview_RateNeevaPromo_landscape_rate() {
    LightDarkPreviewContainer {
