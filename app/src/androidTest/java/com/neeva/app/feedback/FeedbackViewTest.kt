...
import com.neeva.app.apollo.TestApolloClientWrapper
...
class FeedbackViewTest : BaseBrowserTest() {
    ...
    fun cancelFeedback_showsNoSnackbar() {
        androidComposeRule.apply {
            ...
            expectThat(
                (testApolloWrapper.apolloClientWrapper as? TestApolloClientWrapper)
                    ?.performedOperations
                    ?.contains(sendFeedbackMutation) ?: false
            ).isFalse()
        }
    }
